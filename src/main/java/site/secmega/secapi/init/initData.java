...
//            initTimeData();
    ...
    private void initDefectTypeData(){
        ...
        defectType1.setUuid(UUID.randomUUID().toString());
        ...
        defectType13.setUuid(UUID.randomUUID().toString());
        ...
        defectType14.setUuid(UUID.randomUUID().toString());
        ...
        defectType15.setUuid(UUID.randomUUID().toString());
        ...
        defectType18.setUuid(UUID.randomUUID().toString());
        defectTypeRepository.save(defectType18);
        DefectType defectType19 = new DefectType();
        defectType19.setUuid(UUID.randomUUID().toString());
    ...
    private void initTimeData() {
        for (int i = 7; i < 18; i++) {
            ...
            time.setUuid(UUID.randomUUID().toString());
    ...
    private void initDepartment(){
        ...
        cutting.setUuid(UUID.randomUUID().toString());
        ...
        sewing.setUuid(UUID.randomUUID().toString());
        ...
        ironing.setUuid(UUID.randomUUID().toString());
        ...
        qc.setUuid(UUID.randomUUID().toString());
        qc.setDepartment("QC");
        qc.setProcessNo(4);
        ...
        packing.setUuid(UUID.randomUUID().toString());
    ...
    private void initProductionLine(){
        ...
        sewingL1.setUuid(UUID.randomUUID().toString());
        ...
        sewingL2.setUuid(UUID.randomUUID().toString());
        ...
        sewingL3.setUuid(UUID.randomUUID().toString());
        ...
        sewingL4.setUuid(UUID.randomUUID().toString());
        ...
        sewingL5.setUuid(UUID.randomUUID().toString());
        ...
        sewingL6.setUuid(UUID.randomUUID().toString());
        ...
        sewingL7.setUuid(UUID.randomUUID().toString());
        ...
        sewingL8.setUuid(UUID.randomUUID().toString());
